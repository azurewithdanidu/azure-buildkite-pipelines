...
# ---------------------------------------------------------------------------
# bicep-deploy.sh
# Deploys a compiled Bicep template to Azure for any of the four scopes:
...
echo "--- :information_source: Deployment configuration"
...
# Annotate success
# ---------------------------------------------------------------------------
SUBSCRIPTION_DISPLAY="${AZURE_SUBSCRIPTION_ID:-N/A}"

buildkite-agent annotate --style success --context bicep-deploy <<EOF
